...
namespace BACKEND02.Controllers
{
    ...
    public class MarcaController : ControllerBase
    {
        ...
        private ICommonServices<MarcaDto, MarcaDto, MarcaDto> _marcaServices;
        //creamos instancia de las validaciones
        private IValidator<MarcaDto> _marcaInsertValidator;



        //contructor del controller
        public MarcaController(
            IValidator<MarcaDto> marcaInsertValidator,
            ICommonServices<MarcaDto, MarcaDto, MarcaDto> marcaServices)
        {
        ...
        public async Task<ActionResult<MarcaDto>> Add(MarcaDto marcaI)
        {
        ...
        public async Task<ActionResult<MarcaDto>> Update(int id, MarcaDto MarcaU)
        {
